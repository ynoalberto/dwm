...
static const char col_cyan[]        = "#0d7ad9";
...
static const char *roficmd[]  = { "rofi", "-show", "drun", "-sidebar-mode", "-show-icons", "-theme", "Arc-Dark.rasi", "-location", "1", "-xoffset", "9", "-yoffset", "27", "-columns", "2", NULL };
